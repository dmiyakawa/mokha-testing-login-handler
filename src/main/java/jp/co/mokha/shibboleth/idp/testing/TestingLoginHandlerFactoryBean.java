...
import jp.co.mokha.shibboleth.idp.testing.TestingLoginHandler;

/**
 * Factory bean for {@link TestingLoginHandler}s.
 */
public class TestingLoginHandlerFactoryBean extends AbstractLoginHandlerFactoryBean {
    ...
    protected Object createInstance() throws Exception {
        TestingLoginHandler handler = new TestingLoginHandler(authenticationServletURL);
	...
	public Class getObjectType() {
        return TestingLoginHandler.class;
    }
}